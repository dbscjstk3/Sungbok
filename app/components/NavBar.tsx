const NAV_LINKS = [['/', '홈'], ['/players', '선수명단'], ['/match', '내전생성'], ['/history', '기록'], ['/standings', '전적']] as const
...
export default function NavBar() {
  return (
    ...
    >
      <a href="/" className="text-xl font-bold tracking-tight shrink-0 mr-2" style={{ color: '#202020' }}>
        성복내전
      </a>
